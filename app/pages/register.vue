    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-24 relative">
      ...
      <div class="w-full max-w-md space-y-8">
        ...
        <form @submit.prevent="handleRegister" novalidate class="space-y-5">
            ...
            <div class="space-y-2">
              ...
              <div class="relative">
                ...
                <input
                  ...
                  type="text"
                  placeholder="Jean"
                  class="w-full pl-10 pr-4 py-2.5 bg-white border rounded-xl text-on-surface placeholder:text-outline/60 focus:ring-2 focus:ring-primary/20 transition-all outline-none"
            ...
            <div class="space-y-2">
              ...
              <div class="relative">
                ...
                <input
                  ...
                  type="text"
                  placeholder="Dupont"
                  class="w-full pl-10 pr-4 py-2.5 bg-white border border-outline-variant/50 rounded-xl text-on-surface placeholder:text-outline/60 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all outline-none"
                />
              </div>
            </div>
          </div>
          ...
          <div class="space-y-2">
            ...
            <div class="relative">
              ...
              <input
                ...
                autocomplete="email"
                class="w-full pl-11 pr-4 py-2.5 bg-white border rounded-xl text-on-surface placeholder:text-outline/60 focus:ring-2 focus:ring-primary/20 transition-all outline-none"
          ...
          <div class="space-y-2">
            ...
            <div class="relative">
              ...
              <input
                ...
                class="w-full pl-11 pr-12 py-2.5 bg-white border rounded-xl text-on-surface placeholder:text-outline/60 focus:ring-2 focus:ring-primary/20 transition-all outline-none"
          ...
          <button type="submit" :disabled="loading" class="w-full flex items-center justify-center gap-2 py-3 bg-gradient-to-br from-primary to-primary-container text-white font-bold rounded-xl hover:-translate-y-0.5 hover:shadow-lg hover:shadow-primary/25 transition-all disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none disabled:shadow-none mt-2">
