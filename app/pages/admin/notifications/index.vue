...
const smsTemplates = computed(() => templates.value.filter((template) => template.channel === 'SMS'))
...
.btn-primary, .btn-ghost { display: inline-flex; align-items: center; gap: 0.35rem; padding: 0.7rem 1rem; border-radius: 0.65rem; font-size: 0.86rem; font-weight: 700; cursor: pointer; }
